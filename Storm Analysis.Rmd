...
<br>
Even after all that conversion there are still 124 different types of weather events, but the most severe ones should be aggregated into a few names key weather event types. 
```{r}
