...
p5 <- p5 + scale_y_log10() + labs(title = "Crop and Property Damage By Weather Event Type", x="", y="Dollars of Damage, Log Scale") + theme(axis.text.x = element_text(angle = 270, hjust=0))
...
```{r, cache=TRUE, fig.align='center', fig.height=8, fig.width=8}
